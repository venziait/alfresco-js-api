...
import * as configAuth from '../../auth_config.json';
...
export class Oauth2Auth0 extends AlfrescoApiClient {
    ...
    authentications: Authentication = {
        'oauth2': { accessToken: '' }, type: 'oauth0', 'basicAuth': {}
    };
